...
class FSStorage(models.Model):
    ...
    # __slots__ = ("_fs", "_odoo_storage_path")
    # __slots__ = ["env", "_ids", "_prefetch_ids", "_fs", "_odoo_storage_path"]

    # def __init__(self, env, ids=(), prefetch_ids=()):
    #     super().__init__(env, ids=ids, prefetch_ids=prefetch_ids)
    #     self._fs = None
    #     self._odoo_storage_path = None

    _fs = None
    _odoo_storage_path = None
    ...
    @property
    def odoo_storage_path(self):
        return self._odoo_storage_path

    @fs.setter
    def odoo_storage_path(self, value):
        self._odoo_storage_path = value

    def write(self, vals):
        self._fs = None
        # self.pool.clear_caches()
        self.clear_caches()
        return super(FSStorage, self).write(vals)
    ...
    def fs(self) -> fsspec.AbstractFileSystem:
        ...
        self.ensure_one()
        if not self._fs:
            self._fs = self.sudo()._get_filesystem()
        if not tools.config["test_enable"]:
            ...
            try:
                self._check_connection(self._fs, self.check_connection_method)
            except Exception as e:
    ...
    def _odoo_storage_path(self) -> str:
        ...
        when the protocol is filesystem.
        """
        if not self._odoo_storage_path:
            self._odoo_storage_path = self._get_filesystem_storage_path()
        return self._odoo_storage_path
